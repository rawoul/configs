...
-- {{{ Autostart
awful.util.spawn_with_shell(awful.util.getdir("config") .. "/dex -a")
-- }}}
...
-- {{{ Widgets
-- Clock
textclock = awful.widget.textclock("%a %d.%m.%Y %T", 1)

-- Separators
separator = wibox.widget.textbox()
separator:set_markup(fg(beautiful.bg_focus, " | "))
